...
- leverage_ds  {{LEVERAGE_BOARD_DS_ID}}   (⚡ Leverage Board)
...
8. LEVERAGE: if the chat produced postable output and no Leverage row references this Source URL, propose one (Claimed? unchecked = content debt).
9. REPORT what was created/updated, with links; call out any Work Items moved to Done.
